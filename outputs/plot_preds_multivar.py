# Plotting and evaluation for multivariate PatchTST
# ...copy code from outputs/plot_preds.py and update as needed for multivariate...
# TODO: Update this script to handle and visualize multivariate predictions
...
HORIZON     = 10
SEQ_LEN     = 60
PRED_PATH   = "./outputs/patch_preds_multivar.npy"
OUTPUT_PLOT = "./outputs/realized_vol_prediction_plot_multivar.png"
PLOT_WINDOW = 200
...
metrics_out_path = './outputs/metrics_patch_vs_garch_multivar.csv'
...
plt.plot(pred_dates[-PLOT_WINDOW:], preds_flat[-PLOT_WINDOW:], '--', label="PatchTST Multivar Prediction")
plt.plot(pred_dates[-PLOT_WINDOW:], garch[-PLOT_WINDOW:], ':', label="GARCH(1,1) Vol")
plt.title("Realized Volatility: Actual vs. PatchTST Multivar vs. GARCH(1,1)")
plt.xlabel("Date")
