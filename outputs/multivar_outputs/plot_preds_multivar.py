"""
Plot and evaluate multivariate PatchTST predictions vs. GARCH and Kalman targets.
Saves metrics and plot to outputs/multivar_outputs/.
"""
import pandas as pd
import numpy as np
...
HORIZON     = 10
SEQ_LEN     = 60
PRED_PATH   = "./outputs/multivar_outputs/patch_preds_multivar.npy"
OUTPUT_PLOT = "./outputs/multivar_outputs/realized_vol_prediction_plot.png"
PLOT_WINDOW = 200
METRICS_OUT_PATH = './outputs/multivar_outputs/metrics_patch_vs_garch_kalman.csv'
